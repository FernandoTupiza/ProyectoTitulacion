...
use App\Models\ComentarioSoftware;
use App\Http\Resources\Resource;
use Illuminate\Support\Facades\Validator;

class ComentarioSoftwareController extends Controller
{
...
public function store(Request $request)
{
    ...
    }$comentarios = new ComentarioSoftware();
...
//FUNCION PARA VER LOS COMENTARIOS
    public function index (Request $request){
        ...
        $comentarios = ComentarioSoftware::all();
...
//FUNCION PARA VER UN COMENTARIOS
    public function show (Request $request, $id){
        ...
        $comentarios = ComentarioSoftware::find($id);
        if($comentarios){
            return response()->json([
...
//FUNCION PARA ACTUALIZAR COMENTARIOS
    public function update (Request $request, $id){
        ...
        $fields = $request->validate([
            ...
            'materias_id' => 'nullable|numeric',
            'semestres_id' => 'nullable|numeric',
            'carreras_id' => 'nullable|numeric',
