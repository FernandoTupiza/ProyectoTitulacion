...
use App\Models\ComentarioAguas;
use App\Http\Resources\Resource;
use Illuminate\Support\Facades\Validator;

class ComentarioAguasController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        }$comentarios = new ComentarioAguas();
    ...
    public function index (Request $request){
        ...
        $comentarios = ComentarioAguas::all();
...
//FUNCION PARA VER UN COMENTARIOS
    public function show (Request $request, $id){
        ...
        $comentarios = ComentarioAguas::find($id);
        if($comentarios){
            return response()->json([
...
//FUNCION PARA ACTUALIZAR COMENTARIOS
    public function update (Request $request, $id){
        ...
        if($comentarios){
            ...
            return response()->json([
                'message' => 'El comntario se actualizado satisfactoriamente.',
                'data'=> $comentarios
            ]);
        }
        else{
